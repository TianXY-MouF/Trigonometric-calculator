...
% Last Modified by GUIDE v2.5 28-Jun-2021 16:35:08
...
% --- Executes on button press in pushbutton23.为“=”号
...
% --- Executes on button press in pushbutton24.为清空
...
set(handles.edit1,'String','');%操作显示屏
set(handles.edit2,'String','');%结果显示屏
guidata(hObject,handles);


% --- Executes on button press in pushbutton27.为删除
